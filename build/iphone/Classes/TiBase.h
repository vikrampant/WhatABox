...
// in simulator we redefine to format for WhatABox_v1 Developer console
...
{\
	NSString * exceptionName = [@"org.whatabox_v1." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.whatabox_v1";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIWhatABox_v1NativeItemNone = -1, 
	UIWhatABox_v1NativeItemSpinner = -2,
	UIWhatABox_v1NativeItemProgressBar = -3,
	
	UIWhatABox_v1NativeItemSlider = -4,
	UIWhatABox_v1NativeItemSwitch = -5,
	UIWhatABox_v1NativeItemMultiButton = -6,
	UIWhatABox_v1NativeItemSegmented = -7,
	
	UIWhatABox_v1NativeItemTextView = -8,
	UIWhatABox_v1NativeItemTextField = -9,
	UIWhatABox_v1NativeItemSearchBar = -10,
	
	UIWhatABox_v1NativeItemPicker = -11,
	UIWhatABox_v1NativeItemDatePicker = -12,
	
	UIWhatABox_v1NativeItemInfoLight = -13,
	UIWhatABox_v1NativeItemInfoDark = -14,
	
	UIWhatABox_v1NativeItemDisclosure = -15,
	
	UIWhatABox_v1NativeItemContactAdd = -16
};

...
//@interface WhatABox_v1Object : NSObject
//@end

@interface WhatABox_v1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WhatABox_v1Object class]])
		{
			for (NSString *key in [[(WhatABox_v1Object*)o modules] allKeys])
			{
